...
<head>
  ...
  <title> 404 - Not found - Al nezam al asasy</title>
  <!--favicon-->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center error-pages">
                        ...
                        <div class="mt-4">
                          <a href="index.html" class="btn btn-dark btn-round m-1">Go To Home </a>
                          <a href="javascript:void();" class="btn btn-warning btn-round m-1">Previous Page </a>
                        </div>

                        <div class="mt-4">
                            <p class="">Copyright © 2019 Bulona | All rights reserved.</p>
                        </div>
